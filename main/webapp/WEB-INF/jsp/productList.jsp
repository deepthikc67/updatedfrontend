...
<table class="table table-hover" id="product" class="display" border="1" width="80%" align="center">
                        ...
                        <c:forEach var="c" varStatus="st" items="${productList}">
                            ...
                            <a class="btn btn-info" role="button" href="<c:url value="deleteProduct/${c.id}" />">Delete</a>
			<a class="btn btn-info" role="button" href="<c:url value="updateProduct/${c.id}"/>">Update</a>
                                </td> 
                            </tr>
                        </c:forEach>
                    </table>
...
<table class="table table-hover" id="product " class="display" border="1" width="80%" align="center">
                        ...
                        <c:forEach var="c" varStatus="st" items="${productList}">
                            <tr>
                                ...
                                <td><c:out value="${c.productdescription}"></c:out></td> 
                                 <td><c:out value="${c.productstock}"></c:out></td>
